...
export default function Shutter(): ReactNode {
  ...
  return (
    <section className={`flex justify-center items-center transition-all duration-500 absolute bottom-0 bg-black/[0.9] w-full h-[14dvh]`}>
      <button
      ...
      >
        <div
          className={`bg-[#ff3939] ${isRecord ? "w-[50%] h-[50%] rounded" : "w-[70%] h-[70%] rounded-[50px]"} max-w-[100px] max-h-[100px]`}
        ></div>
      </button>
    </section>
  );
